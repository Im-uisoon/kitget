...
const fetchPosts = async (page, sort) => {
  try {
    const response = await axios.get(`http://localhost:8080/api/review/${page}`, {
      params: { sort },
...
<template>
  ...
  <div class="flex items-center justify-center px-100">
    <section class="w-full h-full">
      <!-- 1. 게시물 글 -->
      <h1 class="text-2xl text-black mb-1 mt-14">리뷰</h1>
      <p class="mb-1 text-gray-500">사용리뷰를 남겨주세요</p>
      <hr />
