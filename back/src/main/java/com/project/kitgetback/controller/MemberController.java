...
import com.project.kitgetback.service.MemberService;
...
public class MemberController {
    ...
    public MemberController(VerificationService verificationService, MemberService memberService, AuthenticationManager authenticationManager) {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request, HttpSession session) {
        try {
            ...
            return ResponseEntity.status(401).body(new LoginResponse("이메일 또는 비밀번호를 확인해주세요"));
        }
    }
